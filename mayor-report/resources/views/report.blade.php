...
@section('title', 'Звіти про роботу виконавчих органів Луцької міської ради')
        ...
        <div class="row d-flex view-container">
            ...
            @foreach($list_of_views as $view)
                <div id="{{ $view['id'] }}" class="col-9 col-md-10 col-lg-8 col-xl-7 view rounded shadow bg-white mb-2 p-2"
                     onclick="location.href='@if ($view['id'] == 'book') {{ env('ADMIN_PANEL_URL').preg_replace('/public/', '/storage', $bookUrl) }} @else {{ route($view['url'], $year) }} @endif';"
                >
